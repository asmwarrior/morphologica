    ...
    public:
        ...
        void initAxisLabels()
        {
            if (this->em > 0.0f) {
                ...
                auto vtm1 = std::make_unique<VisualTextModel<gl_maj, gl_min, gles>> (this->parentVis, this->get_tprog(this->parentVis),
                ...
                toffset[0] += this->em;
                auto vtm2 = std::make_unique<VisualTextModel<gl_maj, gl_min, gles>> (this->parentVis, this->get_tprog(this->parentVis),
                                                                                     morph::VisualFont::DVSansItalic,
                                                                                     this->em, 48, toffset,
                                                                                     this->y_label);
                ...
                toffset[0] += this->em;
                auto vtm3 = std::make_unique<VisualTextModel<gl_maj, gl_min, gles>> (this->parentVis, this->get_tprog(this->parentVis),
                                                                                     morph::VisualFont::DVSansItalic,
                                                                                     this->em, 48, toffset,
                                                                                     this->z_label);
