...
namespace morph {
    ...
    public:
         ...
         */
        VisualTextModel (morph::Visual<gl_maj, gl_min, gles>* _vis, GLuint tsp,
                         ...
                         std::array<float, 3> _clr = {0,0,0})
        {
            ...
            this->face = VisualResources<gl_maj, gl_min, gles>::i().getVisualFace (visualfont, this->fontpixels, this->parentVis);
            this->setupText (_txt);
        }
        ...
        VisualTextModel (morph::Visual<gl_maj, gl_min, gles>* _vis, GLuint tsp, const morph::vec<float> _mv_offset, const std::string& _txt, morph::TextFeatures tfeatures)
        {
            this->parentVis = _vis;
            ...
            this->face = VisualResources<gl_maj, gl_min, gles>::i().getVisualFace (tfeatures.font, this->fontpixels, this->parentVis);
            this->setupText (_txt);
        }
         ...
         * position, clr);
         */
        VisualTextModel (morph::Visual<gl_maj, gl_min, gles>* _vis, GLuint tsp, morph::VisualFont visualfont, float _m_width, int _fontpixels)
        {
            this->parentVis = _vis;
            this->tshaderprog = tsp;
            this->m_width = _m_width;
        ...
        VisualTextModel (morph::Visual<gl_maj, gl_min, gles>* _vis, GLuint tsp, morph::TextFeatures tfeatures)
        {
            this->parentVis = _vis;
            this->tshaderprog = tsp;
            this->m_width = tfeatures.fontsize;
    ...
    public:
        ...
        //! Parent Visual
        morph::Visual<gl_maj, gl_min, gles>* parentVis = nullptr;
    protected:
